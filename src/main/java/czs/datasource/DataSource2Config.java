 ...
 * 第4步说过注意前缀，就是在下面的@ConfigurationProperties(prefix = "spring.datasource.test2")中，是根据这个来选择数据源的
 *//*

// DataSource02
@Configuration // 注册到springboot容器中
@MapperScan(basePackages = "czs.mapper2", sqlSessionFactoryRef = "test2SqlSessionFactory")
